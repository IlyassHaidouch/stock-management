	...
	<div class="container">
		<div class="panel panel-primary margetop">
			...
			<div class="panel-body">
				<form method="post" action="updateSortie.php" class="form">
					...
					<div class="form-group">
						...
						<input type="number" step="0.01" name="prixV" placeholder="Prix de vente" value="<?php echo $prixV;?>" id="prixV" class="form-control">
					</div>
...
<script src="../js/editerS.js"></script>